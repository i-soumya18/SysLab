...
- Strict Step 4-6 acceptance scenario added and passing: `apps/backend/src/test/mvle-6-8-golden-journey.e2e.test.ts`
- Automated before/after proof added in Workspace: `Before vs After` panel driven by run summaries
- Deterministic timeline ordering regression added and passing: `apps/frontend/src/test/simulation-timeline-ordering.test.ts`
