...
## Component Location
- Frontend: `apps/frontend/src/components/ScaleControl.tsx`
- Integration: `apps/frontend/src/components/Workspace.tsx`
- Styles: `apps/frontend/src/components/ScaleControl.css`
...
- Location: `apps/backend/src/services/scaleSimulationService.ts`
- Tests: `apps/backend/src/test/scale-control.test.ts`
