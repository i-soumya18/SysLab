...
# 
# Usage: bash aws-deployment/setup-infrastructure.sh
# ============================================
...
CONFIG_FILE="aws-deployment/aws-config.env"
cat > "$CONFIG_FILE" << EOF
...
echo "4. Create ALB and target groups (see aws-deployment/ALB_SETUP.md)"
echo "5. Register ECS task definitions (see aws-deployment/ecs-task-definitions/)"
...
echo "  - aws-deployment/ecs-task-definitions/backend-task-def.json"
echo "  - aws-deployment/ecs-task-definitions/frontend-task-def.json"
