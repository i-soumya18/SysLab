...
# Follow: aws-deployment/AWS_DEPLOYMENT_GUIDE.md#networking--security-setup
...
**Output:**
- `aws-deployment/aws-config.env` - Configuration file with endpoints and ARNs
...
3. Runs `database/init.sql` - Creates extensions and functions
4. Runs `database/migrations/004_user_isolation_tables.sql` - Creates schema
